"""
Django settings for ga_voting_api project.
"""
...
ROOT_URLCONF = 'ga_voting_api.urls'
...
WSGI_APPLICATION = 'ga_voting_api.wsgi.application'
...
# Encryption Key for sensitive data (fiscal codes, names, etc.)
